...
var CompanyComponent = (function () {
    function CompanyComponent(router, seoService) {
        this.router = router;
...
var LandingComponent = (function () {
    function LandingComponent(router, route, navigationService, analyticsService, seoService, commonService) {
        ...
        this.commonService.getServicesForCategoryTitle('Professionisti').then(function (professionals) {
            _this.professionals = professionals.result[0].services;
        }).catch(function (error) {
            _this.professionals = null;
        });
        this.commonService.getServicesForCategoryTitle('Casa').then(function (inHouseServices) {
            _this.inHouseServices = inHouseServices.result[0].services;
        }).catch(function (error) {
            _this.inHouseServices = null;
        });
...
var CheckoutComponent = (function () {
    ...
    CheckoutComponent.prototype.changeToRecoverPassword = function () {
