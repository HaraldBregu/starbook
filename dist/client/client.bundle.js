...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_universal__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular2_universal__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_analytics_service__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_seo_service__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_universal__ = __webpack_require__(13);
        ...
        if (this.Order.date && this.isAddressFull) {
            ...
            if (userData !== null && (this.wizardData.type === 'contanti' || this.wizardData.type === 'carta')) {
                ...
                this.orderService.saveOrder(this.Order)
                    ...
                    _this.isLoading = false;
                    if (_this.step === 'confirmation' || _this.step === 'registration' || _this.step === 'addcard') {
    ...
    WizardComponent.prototype.addCard = function () {
        ...
        if (!error) {
            ...
            this.paymentService.addNewCard(this.addCardData)
                .then(function (response) {
                _this.analyticsService.sendTiming({ category: 'Wizard add new card', timingVar: 'save', timingValue: Date.now() - timeStart_3 });
                _this.isLoading = false;
                _this.createOrder();
            })
                .catch(function (error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_universal__ = __webpack_require__(13);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angular2_universal__ = __webpack_require__(13);
