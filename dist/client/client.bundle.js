    ...
    function LandingComponent(router, route, navigationService, analyticsService, seoService) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_5_angular2_universal__["isBrowser"]) {
            ...
            this.route.params.subscribe(function (params) {
                ...
                else if (_this.page === 'carpenters') {
                    _this.navigationService.updateMessage('Falegname');
                }
                else if (_this.page === 'bricklayers') {
                ...
                console.log('this page is: ' + _this.page);
            });
        }
    }
                ...
                if (_this.page === 'starbook') {
                    ...
                    _this.route.queryParams.subscribe(function (params) {
                        ...
                        if (estimateParams) {
                            ...
                            console.log('share link is: ' + _this.sharelink);
                            try {
