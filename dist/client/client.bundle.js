...
var ServiceComponent = (function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            if (!service_id) {
                ...
                _this.commonService.getServiceById(service_id).then(function (data) {
                    ...
                    _this.commonService.getAccountsByServiceId(data.result._id).then(function (data) {
    ...
    ServiceComponent.prototype.getPriceStringPerUnit = function (price) {
        var p = price / 100;
        return '€' + p.toFixed(2);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__app_component__ = __webpack_require__(524);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__home_home_component__ = __webpack_require__(528);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__order_order_component__ = __webpack_require__(531);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__pages_share_share_component__ = __webpack_require__(533);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_blog_blog_component__ = __webpack_require__(532);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__directives_clipboard_directive__ = __webpack_require__(526);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__directives_formatter_directive__ = __webpack_require__(527);
