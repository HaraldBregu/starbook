        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.route.queryParams.subscribe(function (params) {
                if (_this.page === 'login' && !_this.currentUser) {
                    ...
                    _this.seoObject['description'] = "Sei un professionista, hai un mestiere particolare, un attività o lavori in proprio iscriviti su Starbook e sul primo servizio effettuato riceverai 25€";
                    _this.seoObject['image_url'] = "https://s3-eu-west-1.amazonaws.com/starbook-s3/website/promotion_earn_25_euro.png";
                }
