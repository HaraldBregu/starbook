...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angular2_universal__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angular2_universal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_angular2_universal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_auth_service__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_facebook__ = __webpack_require__(241);
...
var CompanyComponent = (function () {
    ...
    CompanyComponent.prototype.continueWithFacebook = function () {
        // if (isBrowser) {
    ...
    CompanyComponent.prototype.checkAccessToken = function (facebookWindow, context) {
        var _this = this;
        if (facebookWindow.closed) {
            var accessToken = localStorage.getItem('facebook_token');
            this.authServics.facebookLogin(accessToken).then(function (userData) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_common_service__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_profile_service__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_universal__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_universal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_angular2_universal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_auth_service__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_contact_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__popups_popups_service__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shared_common_service__ = __webpack_require__(32);
...
var AccountComponent = (function () {
    function AccountComponent(route, router, navigationService, profileService, authService, seoService, contactService, popupsService, commonService) {
        var _this = this;
        this.route = route;
        this.router = router;
        this.navigationService = navigationService;
    ...
    AccountComponent.prototype.saveInformations = function () {
        ...
        this.profileService.updateProfile(this.Account).then(function (data) {
            if (data.success) {
                ...
                if (_this.Picture.file) {
                    _this.saveProfilePictureToPath(_this.Picture.file, 'accounts/' + _this.Account['_id'] + '/avatar/0');
                }
                else {
    ...
    AccountComponent.prototype.saveProfilePictureToPath = function (file, path) {
        var _this = this;
        if (file) {
    ...
    AccountComponent.prototype.checkImageUrlFromAccount = function (account) {
        var image = new Image();
    ...
    AccountComponent.prototype.shareOnFacebook = function (service) {
        if (__WEBPACK_IMPORTED_MODULE_4_angular2_universal__["isBrowser"]) {
    ...
    AccountComponent.prototype.shareOnTwitter = function (service) {
        if (__WEBPACK_IMPORTED_MODULE_4_angular2_universal__["isBrowser"]) {
            // var sharelink = window.location.href
            var sharelink = document.location.protocol + '//' + document.location.hostname + '/services/' + service['_id'];
            var left = Math.round((document.documentElement.clientWidth / 2) - 285);
    ...
    AccountComponent.prototype.shareOnLinkedin = function (service) {
        if (__WEBPACK_IMPORTED_MODULE_4_angular2_universal__["isBrowser"]) {
            // var sharelink = window.location.href
            var sharelink = document.location.protocol + '//' + document.location.hostname + '/services/' + service['_id'];
            var link = sharelink;
...
var AuthComponent = (function () {
    function AuthComponent(route, router, navigationService, profileService, authService, seoService, contactService) {
        this.route = route;
        this.router = router;
        this.navigationService = navigationService;
        this.profileService = profileService;
    ...
    AuthComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.route.queryParams.subscribe(function (params) {
                if (_this.page === 'login' && !_this.currentUser) {
                ...
                else if (_this.page === 'professional' && !_this.currentUser) {
                    ...
                    _this.seoObject['title'] = "Iscriviti su Starbook e ricevi 25€";
                    _this.seoObject['description'] = "Sei un professionista, hai un mestiere particolare, un attività o lavori in proprio? Iscriviti su Starbook e al primo servizio effettuato riceverai 25€";
                    _this.seoObject['image_url'] = "https://s3-eu-west-1.amazonaws.com/starbook-s3/website/promotion_25_euro_bonus.png";
                }
    ...
    AuthComponent.prototype.signupAsProfessional = function () {
        var _this = this;
        if (this.signup_state.loading || this.facebook_state.loading) {
            return;
        }
    ...
    AuthComponent.prototype.continueWithFacebook = function () {
    ...
    AuthComponent.prototype.checkAccessToken = function (facebookWindow, context, timeStart) {
        var _this = this;
        if (facebookWindow.closed) {
            var accessToken = localStorage.getItem('facebook_token');
    ...
    AuthComponent.prototype.changeToSignup = function () {
    ...
    AuthComponent.prototype.goToHomePage = function () {
        this.router.navigate(['']);
    };
    AuthComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["e" /* ActivatedRoute */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["e" /* ActivatedRoute */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* Router */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* Router */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__shared_navigation_service__["a" /* NavigationService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__shared_navigation_service__["a" /* NavigationService */]) === 'function' && _c) || Object, (typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__shared_profile_service__["a" /* ProfileService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__shared_profile_service__["a" /* ProfileService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__shared_auth_service__["a" /* AuthService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__shared_auth_service__["a" /* AuthService */]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_7__shared_seo_service__["a" /* SeoService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_7__shared_seo_service__["a" /* SeoService */]) === 'function' && _f) || Object, (typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_6__shared_contact_service__["a" /* ContactService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__shared_contact_service__["a" /* ContactService */]) === 'function' && _g) || Object])
    ], AuthComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__posts_service__ = __webpack_require__(218);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_universal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_angular2_universal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_common_service__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_facebook__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_contact_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__posts_service__ = __webpack_require__(218);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_auth_service__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_profile_service__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_common_service__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_orders_service__ = __webpack_require__(87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_auth_service__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_universal__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_universal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_angular2_universal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_common_service__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__share_share_service__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pipes_currency_pipe__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pipes_currency_cent_pipe__ = __webpack_require__(550);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_universal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_angular2_universal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_common_service__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_profile_service__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_common_service__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_common_service__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__2_1_1_workaround_ts__ = __webpack_require__(535);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__2_1_1_workaround_ts___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__2_1_1_workaround_ts__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workaround_browser__ = __webpack_require__(536);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__environments_environment__ = __webpack_require__(556);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular2_universal__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular2_universal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_angular2_universal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_app_browser_module__ = __webpack_require__(537);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_toPromise__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_toPromise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_toPromise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(762);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__navigation_service__ = __webpack_require__(9);
...
var __universal__ = __webpack_require__(558);
if (patch) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ng2_click_outside__ = __webpack_require__(721);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ng2_page_scroll__ = __webpack_require__(722);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ngx_facebook__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_routing__ = __webpack_require__(539);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_common_service__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__shared_auth_service__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__shared_contact_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_share_share_service__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__shared_clipboard_service__ = __webpack_require__(357);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_blog_posts_service__ = __webpack_require__(218);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__app_component__ = __webpack_require__(538);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__landing_landing_component__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__company_company_component__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_category_category_component__ = __webpack_require__(544);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_service_service_component__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_services_services_component__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_insert_insert_component__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_checkout_checkout_component__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_orders_orders_component__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_profile_profile_component__ = __webpack_require__(546);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__popups_popups_component__ = __webpack_require__(554);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pipes_phone_pipe__ = __webpack_require__(553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pipes_expiry_pipe__ = __webpack_require__(552);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__shared_loading_loading_component__ = __webpack_require__(555);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_facebook_facebook_component__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_wizard_wizard_component__ = __webpack_require__(549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_about_about_component__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pages_help_help_component__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__pages_legal_legal_component__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__pages_account_account_component__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__pages_auth_auth_component__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__pages_requests_requests_component__ = __webpack_require__(547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_share_share_component__ = __webpack_require__(548);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_contact_contact_component__ = __webpack_require__(545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__pages_notfound_notfound_component__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pages_tests_tests_component__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__pages_blog_blog_component__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__pages_blog_post_post_component__ = __webpack_require__(346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__directives_clipboard_directive__ = __webpack_require__(540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__directives_formatter_directive__ = __webpack_require__(541);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__pipes_currency_pipe__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__pipes_currency_format_pipe__ = __webpack_require__(551);
...
var declarations = [
    ...
    __WEBPACK_IMPORTED_MODULE_42__pages_auth_auth_component__["a" /* AuthComponent */],
    ...
    __WEBPACK_IMPORTED_MODULE_43__pages_requests_requests_component__["a" /* RequestsComponent */],
    __WEBPACK_IMPORTED_MODULE_44__pages_share_share_component__["a" /* ShareComponent */],
    __WEBPACK_IMPORTED_MODULE_48__pages_blog_blog_component__["a" /* BlogComponent */],
    __WEBPACK_IMPORTED_MODULE_49__pages_blog_post_post_component__["a" /* PostComponent */],
    ...
    __WEBPACK_IMPORTED_MODULE_47__pages_tests_tests_component__["a" /* TestsComponent */],
    __WEBPACK_IMPORTED_MODULE_50__directives_clipboard_directive__["a" /* ClipboardDirective */],
    __WEBPACK_IMPORTED_MODULE_51__directives_formatter_directive__["a" /* FormatterDirective */],
    __WEBPACK_IMPORTED_MODULE_52__pipes_currency_pipe__["a" /* CurrencyPipe */],
    ...
    __WEBPACK_IMPORTED_MODULE_53__pipes_currency_format_pipe__["a" /* CurrencyFormatPipe */]
];
var exp = [
    __WEBPACK_IMPORTED_MODULE_51__directives_formatter_directive__["a" /* FormatterDirective */],
    __WEBPACK_IMPORTED_MODULE_52__pipes_currency_pipe__["a" /* CurrencyPipe */],
...
if (__WEBPACK_IMPORTED_MODULE_2_angular2_universal__["isBrowser"]) {
    var CalendarModule = __webpack_require__(728).CalendarModule;
    imports.push(CalendarModule);
    var AutoCompleteModule = __webpack_require__(727).AutoCompleteModule;
    imports.push(AutoCompleteModule);
}
else {
    var CalendarMockComponent = __webpack_require__(543).CalendarMockComponent;
    declarations.push(CalendarMockComponent);
    var AutoCompleteMockModule = __webpack_require__(542).AutoCompleteMockComponent;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_common_service__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_seo_service__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__landing_landing_component__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__company_company_component__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_service_service_component__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_services_services_component__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_insert_insert_component__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_checkout_checkout_component__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_orders_orders_component__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_facebook_facebook_component__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_about_about_component__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_help_help_component__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_legal_legal_component__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_account_account_component__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_auth_auth_component__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_notfound_notfound_component__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_tests_tests_component__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_blog_blog_component__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_blog_post_post_component__ = __webpack_require__(346);
...
var routes = [
    ...
    { path: 'company', component: __WEBPACK_IMPORTED_MODULE_2__company_company_component__["a" /* CompanyComponent */], data: { name: 'Company' } },
    { path: 'company/:page', component: __WEBPACK_IMPORTED_MODULE_2__company_company_component__["a" /* CompanyComponent */], data: { name: 'Company' } },
    ...
    { path: 'orders', component: __WEBPACK_IMPORTED_MODULE_7__pages_orders_orders_component__["a" /* OrdersComponent */], data: { name: 'Orders' } },
    { path: 'orders/:page', component: __WEBPACK_IMPORTED_MODULE_7__pages_orders_orders_component__["a" /* OrdersComponent */], data: { name: 'Orders' } },
    ...
    { path: 'services', component: __WEBPACK_IMPORTED_MODULE_4__pages_services_services_component__["a" /* ServicesComponent */], data: { name: 'Service', isFindField: true } },
    ...
    { path: 'info/help', component: __WEBPACK_IMPORTED_MODULE_10__pages_help_help_component__["a" /* HelpComponent */], data: { name: 'Info' } },
    { path: 'info/legal', component: __WEBPACK_IMPORTED_MODULE_11__pages_legal_legal_component__["a" /* LegalComponent */], data: { name: 'Info' } },
    { path: 'info/about', component: __WEBPACK_IMPORTED_MODULE_9__pages_about_about_component__["a" /* AboutComponent */], data: { name: 'Info' } },
    // TESTS
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_clipboard_service__ = __webpack_require__(357);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pipes_currency_pipe__ = __webpack_require__(220);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__popups_popups_service__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_payment_service__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_seo_service__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_contact_service__ = __webpack_require__(52);
...
var ProfileComponent = (function () {
    function ProfileComponent(profileService, router, navigationService, route, popupsService, paymentService, joinService, seoService) {
        this.profileService = profileService;
        this.router = router;
        this.navigationService = navigationService;
        this.route = route;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_contact_service__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__share_service__ = __webpack_require__(219);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_orders_service__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_auth_service__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_navigation_service__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__shared_payment_service__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_profile_service__ = __webpack_require__(74);
...
var PopupsComponent = (function () {
    function PopupsComponent(authServics, navigationService, popupService, ordersService, orderService, paymentService, router) {
        this.authServics = authServics;
        this.navigationService = navigationService;
    ...
    PopupsComponent.prototype.facebookLogin = function () {
        if (__WEBPACK_IMPORTED_MODULE_0_angular2_universal__["isBrowser"]) {
            var left = Math.round((document.documentElement.clientWidth / 2) - 285);
            var facebookPopup = window.open('https://www.facebook.com/v2.8/dialog/oauth?client_id=1108461325907277&response_type=token&scope=email,public_profile,user_location,user_website,user_work_history&redirect_uri=http://www.starbook.co/facebook', '_blank', 'location=yes,height=570,width=520,left=' + left + ', top=100,scrollbars=yes,status=yes');
            this.checkAccessToken(facebookPopup, 1);
        }
    };
    ...
    PopupsComponent.prototype.registration = function (firstname, lastname, phone, email, password) {
        var _this = this;
        if (this.emailPattern.test(email) &&
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_universal_polyfills__ = __webpack_require__(559);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angular2_universal_polyfills___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_angular2_universal_polyfills__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_es6_symbol__ = __webpack_require__(578);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_es6_symbol___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_core_js_es6_symbol__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_js_es6_object__ = __webpack_require__(571);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_js_es6_object___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_core_js_es6_object__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_js_es6_function__ = __webpack_require__(567);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_js_es6_function___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_core_js_es6_function__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_js_es6_parse_int__ = __webpack_require__(573);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_js_es6_parse_int___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_core_js_es6_parse_int__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_core_js_es6_parse_float__ = __webpack_require__(572);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_core_js_es6_parse_float___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_core_js_es6_parse_float__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_js_es6_number__ = __webpack_require__(570);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_core_js_es6_number___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_core_js_es6_number__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_core_js_es6_math__ = __webpack_require__(569);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_core_js_es6_math___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_core_js_es6_math__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_js_es6_string__ = __webpack_require__(577);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_core_js_es6_string___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_core_js_es6_string__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_core_js_es6_date__ = __webpack_require__(566);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_core_js_es6_date___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_core_js_es6_date__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_core_js_es6_array__ = __webpack_require__(565);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_core_js_es6_array___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_core_js_es6_array__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_core_js_es6_regexp__ = __webpack_require__(575);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_core_js_es6_regexp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_core_js_es6_regexp__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_core_js_es6_map__ = __webpack_require__(568);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_core_js_es6_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_core_js_es6_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_core_js_es6_set__ = __webpack_require__(576);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_core_js_es6_set___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_core_js_es6_set__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_core_js_es6_reflect__ = __webpack_require__(574);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_core_js_es6_reflect___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14_core_js_es6_reflect__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_core_js_es7_reflect__ = __webpack_require__(579);
...
module.exports = "<nav *ngIf=\"page && hasNavigation\" class=\"navbar navbar-dark navbar-fixed-top bg-inverse\" [style.border-bottom]=\"border_bottom_color\" (window:resize)=\"onResize()\">\n  <div class=\"container-starbook top-menu\">\n    <a class=\"navbar-brand\" (click)=\"clickBrandLogo()\">\n      <img *ngIf=\"brandLogo()\" [src]=\"brandLogo()\" alt=\"starbook\">\n    </a>\n    <div *ngIf=\"hasCenterContainer\" class=\"center-container\">\n      <div class=\"search-block\" *ngIf=\"isFindField\">\n        <p-autoComplete [(ngModel)]=\"findValue\" [suggestions]=\"results\" field=\"title\" scrollHeight=\"250px\" (completeMethod)=\"search($event)\" (onSelect)=\"selectResult(findValue)\" placeholder=\"Cerca un altro servizio\" minLength=\"0\">\n          <template let-res>\n            <div class=\"search-result\" (click)=\"selectResult(res)\">{{ res.title }}</div>\n          </template>\n        </p-autoComplete>\n        <div class=\"spinner\" *ngIf=\"spinerView\">\n          <svg width='20px' height='20px' xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMidYMid\" class=\"uil-ring\">\n            <rect x=\"0\" y=\"0\" width=\"100\" height=\"100\" fill=\"none\" class=\"bk\"></rect>\n            <circle cx=\"50\" cy=\"50\" r=\"45\" stroke-dasharray=\"169.64600329384882 113.09733552923257\" stroke=\"#3B568D\" fill=\"none\" stroke-width=\"10\">\n              <animateTransform attributeName=\"transform\" type=\"rotate\" values=\"0 50 50;180 50 50;360 50 50;\" keyTimes=\"0;0.5;1\" dur=\"1s\" repeatCount=\"indefinite\" begin=\"0s\"></animateTransform>\n            </circle>\n          </svg>\n        </div>\n        <div class=\"close-container\" *ngIf=\"!spinerView && clearView\">\n          <span class=\"close rounded thick\" (click)=\"clearSearchForm()\"></span>\n        </div>\n        <div class=\"ui-autocomplete-panel empty\" *ngIf=\"results.length === 0 && findValue.length > 0 && isSearched\">\n          <div class=\"no-result\">\n            Il servizio \"{{findValue}}\" non è disponibile\n            <button class=\"suggess-service\" (click)=\"requireService()\">{{newServiceRequest.message}}</button>\n          </div>\n        </div>\n      </div>\n      <div *ngIf=\"!isFindField\" class=\"tagline\">{{tagline}}</div>\n    </div>\n\n    <!-- <ul *ngIf=\"auth !== false && hasRightContainer\" class=\"nav navbar-nav float-xs-right\" [ngClass]=\"{'collapse':!collapsed}\">\n      <li class=\"nav-item\">\n        <a class=\"nav-link home\" routerLink=\"\" (click)=\"updateTabMenu(true)\">Home</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link orders\" routerLink=\"/orders/requests\" (click)=\"toggleMenu()\">Ordini</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link profile\" routerLink=\"/account/profile\" (click)=\"toggleMenu()\"><i class=\"fa fa-user-circle-o\" aria-hidden=\"true\"> </i> {{getUsername()}}</a>\n      </li>\n    </ul>\n\n    <ul *ngIf=\"auth === false && browser && hasRightContainer\" class=\"nav navbar-nav float-xs-right\" [ngClass]=\"{'collapse':!collapsed}\">\n      <li class=\"nav-item\" *ngIf=\"collapsed\">\n        <a class=\"nav-link home\" routerLink=\"\" (click)=\"updateTabMenu(true)\">Home</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link profile\" (click)=\"getLoginPopup()\">Entra</a>\n      </li>\n    </ul> -->\n\n    <div class=\"user-container dropdown\" *ngIf=\"hasRightContainer\">\n      <!-- <a class=\"user\" data-toggle=\"dropdown\"><img class=\"image\" src=\"../assets/images/no_user.png\" alt=\"Starbook User\"></a> -->\n      <a class=\"user\" data-toggle=\"dropdown\">\n        <img *ngIf=\"!auth\" class=\"image\" src=\"../assets/images/no_user.png\" alt=\"Starbook User\">\n        <img *ngIf=\"auth\" class=\"image\" [src]=\"account_avatar_url\" (error)=\"errorHandler($event)\" alt=\"Starbook User\">\n        <!-- <img *ngIf=\"auth\" class=\"image\" [src]=\"../assets/images/no_user.png\" onError=\"../assets/images/no_user.png\" alt=\"Starbook User\"> -->\n      </a>\n      <ul class=\"dropdown-menu\">\n        <!-- <li class=\"list-item\"><a class=\"btn btn-default\" routerLink=\"/\">Home</a></li> -->\n        <li class=\"list-item\" *ngIf=\"auth\"><a class=\"btn btn-default\" routerLink=\"/account/profile\">{{getUsername()}}</a></li>\n        <li class=\"list-item\" *ngIf=\"!auth\" (click)=\"getLoginPopup()\"><a class=\"btn btn-default\">Entra adesso</a></li>\n        <li class=\"list-item\" *ngIf=\"!auth\"><a class=\"btn btn-default\" routerLink=\"/company\">Sei un professionista?</a></li>\n        <li class=\"list-item\"><a class=\"btn btn-default\" routerLink=\"/insert/product\">Pubblica un servizio</a></li>\n        <li class=\"list-item\" *ngIf=\"auth\"><a class=\"btn btn-default\" routerLink=\"/orders/requests\">Ordini</a></li>\n        <li class=\"list-item line\"></li>\n        <!-- <li class=\"list-item\" *ngIf=\"auth\"><a class=\"btn btn-default\" routerLink=\"/account/profile\">Account</a></li> -->\n        <li class=\"list-item\"><a class=\"btn btn-default\" routerLink=\"/blog\">Blog</a></li>\n        <li class=\"list-item line\"></li>\n        <li class=\"list-item\"><a class=\"btn btn-default\" routerLink=\"/info/legal\">Privacy & Condizioni</a></li>\n        <!-- <li class=\"list-item\"><a class=\"btn btn-default\" routerLink=\"/info/about\">Chi siamo</a></li> -->\n        <li class=\"list-item line\"></li>\n        <li class=\"list-item\"><a class=\"btn btn-default\" routerLink=\"/info/help\">Aiuto</a></li>\n        <!-- <li class=\"list-item\" *ngIf=\"auth\" (click)=\"logout()\"><a class=\"btn btn-default\">Esci</a></li> -->\n      </ul>\n    </div>\n\n  </div>\n</nav>\n\n<!-- <nav class=\"navbar navbar-dark navbar-fixed-top bg-inverse\" [style.border-bottom]=\"border_bottom_color\" (window:resize)=\"onResize()\">\n  <div class=\"container-starbook top-menu\">\n    <a class=\"navbar-brand\" (click)=\"clickBrandLogo()\">\n      <img *ngIf=\"brandLogo()\" [src]=\"brandLogo()\" alt=\"starbook\">\n    </a>\n  </div>\n</nav> -->\n\n\n\n<router-outlet></router-outlet>\n<app-popups></app-popups>\n"
...
module.exports = "<div class=\"company-container\" *ngIf=\"!page\">\n  <div class=\"header-container\">\n    <div class=\"overlay\">\n      <div class=\"header\">\n        <h1>Cresci la tua impresa, facile come fissare un tassello</h1>\n        <p>Entra nella miglior piattaforma professionale per aumentare i tuoi clienti.<br>Prova Starbook adesso!</p>\n        <button class=\"btn btn-facebook\" (click)=\"continueWithFacebook()\"><i class=\"fa fa-facebook-official\" aria-hidden=\"true\"></i>   Continua con Facebook</button>\n        <small>Diamo valore al privacy e non condividiamo mai le tue informazioni</small>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"section-container\">\n    <div class=\"section\">\n      <h2>Come Starbook cambierà la tua impresa?</h2>\n    </div>\n  </div>\n  <div class=\"section-container white-backgound\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/crescita-clienti-guadagni.png\" alt=\"Crescita clienti e guadagni\">\n      </div>\n      <div class=\"descr\">\n        <h3>Crescita dei clienti e dei guadagni, gratis!</h3>\n        <p>Aumentando la clientela, si aumenta il guadagno e il fatturato annuale. Utilizzerai i giusti strumenti per farlo, gratis per sempre!</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/calculator.png\" alt=\"Prezzo lo decidi tu\">\n      </div>\n      <div class=\"descr\">\n        <h3>Mantenendo il prezzo giusto per sempre</h3>\n        <p>Scegli il prezzo che lo ritieni più giusto e non dovrai giocare al ribasso. Mostra professionalità, correttezza e il tuo prezzo per sempre.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container white-backgound\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/trophy.png\" alt=\"Diventando più competitivi della concorrenza\">\n      </div>\n      <div class=\"descr\">\n        <h3>Diventando più competitivi della concorrenza</h3>\n        <p>La competizione è molto importante, ma più è importante vincerla. Per farlo va mostrato velocità, accuratezza e professionalità. Ti aiutiamo noi ad avere tutto quello che ti serve!</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/computer.png\" alt=\"Presenza professionale online e gratis\">\n      </div>\n      <div class=\"descr left\">\n        <h3>Presenza professionale online e gratis!</h3>\n        <p>La professionalità prima di essere percepita deve essere mostrata. Per questo noi offriamo tutte le funzionalità per migliorare l'immagine di un impresa.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small white-backgound\">\n    <div class=\"section\">\n      <div class=\"actions\">\n        <button class=\"btn btn-facebook\" (click)=\"continueWithFacebook()\"><i class=\"fa fa-facebook-official\" aria-hidden=\"true\"></i>   Continua con Facebook</button>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"section-container small\">\n    <div class=\"section\">\n      <h2>Senza dimenticare i servizi aggiuntivi</h2>\n    </div>\n  </div>\n  <div class=\"section-container small white-backgound\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/pie-chart.png\" alt=\"Marketing gratis\">\n      </div>\n      <div class=\"descr left\">\n        <h3>Marketing gratis della tua azienda</h3>\n        <p>Utilizzeremo i metodi più efficienti per promuovere la tua azienda senza costi aggiuntivi. Non hai bisogno di utilizzare agenzie di pubblicità ma solo degli strumenti necessari per poter crescere la tua attività.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/office-material.png\" alt=\"Professionalità e competenze\">\n      </div>\n      <div class=\"descr left\">\n        <h3>Riconquista i vecchi clienti</h3>\n        <p>Anche i tuoi vecchi clienti si possono conquistare, ma per farlo devono essere utilizzate le ultime metodi e tecnologie. Ti sarà facile poi con un click invitare tutti i tuoi vecchi clienti a vedere il tuo profilo e riconquistarli.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small white-backgound\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/list.png\" alt=\"Marketing gratis\">\n      </div>\n      <div class=\"descr left\">\n        <h3>Preventivi digitali con la tua firma</h3>\n        <p>Non devi scrivere più a mano tutto il preventivo e spedirlo tramite email. Noi ti offriamo lo strumento perfetto per inviare email professionali o sms con la tua firma. Non dimenticare, inviando email professionali hai 90% di probabilità di successo in più rispetto alla tua concorrenza.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/barchart.png\" alt=\"Marketing gratis\">\n      </div>\n      <div class=\"descr left\">\n        <h3>Espansione della tua attività</h3>\n        <p>Non devi scrivere più a mano tutto il preventivo e spedirlo tramite email. Noi ti offriamo lo strumento perfetto per inviare email professionali o sms con la tua firma. Non dimenticare, inviando email professionali hai 90% di probabilità di successo in più rispetto alla tua concorrenza.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small white-backgound\">\n    <div class=\"section\">\n      <div class=\"image left\">\n        <img src=\"../assets/images/customer-service.png\" alt=\"Assistenza 24/24 - 7/7 senza sosta\">\n      </div>\n      <div class=\"descr left\">\n        <h3>Assistenza 24/24 - 7/7 senza sosta</h3>\n        <p>L’assistenza è molto importante per poter facilitare il tuo lavoro e risolvere problemi. Per questo siamo qui 24/24 - 7/7 full time. Non esitare a chiamare o ad inviarci una mail con richieste o problemi vari.</p>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small\">\n    <div class=\"section\">\n      <div class=\"actions\">\n        <button class=\"btn btn-facebook\" (click)=\"continueWithFacebook()\"><i class=\"fa fa-facebook-official\" aria-hidden=\"true\"></i>   Continua con Facebook</button>\n      </div>\n    </div>\n  </div>\n  <div class=\"section-container small white-backgound\">\n    <div class=\"section\">\n      <div class=\"links\">\n        <h5>Siamo qui per te</h5>\n        <p>Per qualsiasi domanda o richiesta contattaci</p>\n        <ul class=\"contact-list\">\n          <li><a href=\"mailto:info@starbook.co\" target=\"_blank\"><i class=\"fa fa-envelope\" aria-hidden=\"true\"></i><span>info@starbook.co</span></a></li>\n          <li><a href=\"tel:+393272415028\" target=\"_blank\"><i class=\"fa fa-phone\" aria-hidden=\"true\"></i><span>(39) 327 2415028</span></a></li>\n        </ul>\n        <p><a href=\"/info/legal\" target=\"_blank\">Termini e Condizioni</a></p>\n      </div>\n    </div>\n  </div>\n\n  <!-- <div class=\"bullets-container\">\n    <h1>Come funziona</h1>\n    <div class=\"row bullets\">\n      <div class=\"col-xl-4 col-lg-4 col-md-6 col-sm-12\">\n        <div class=\"box\">\n          <img src=\"../../../assets/images/subscribe-icon.png\" class=\"rounded mx-auto d-block\" alt=\"Seleziona il servizio\">\n          <h3>Iscriviti</h3>\n          <h5>Racontaci del servizio che offri, quanto costa e carica una foto. É cosi semplice, ed é gratis!</h5>\n        </div>\n      </div>\n      <div class=\"col-xl-4 col-lg-4 col-md-6 col-sm-12\">\n        <div class=\"box\">\n          <img src=\"../../../assets/images/client-icon.png\" class=\"rounded mx-auto d-block\" alt=\"Calcola preventivo\">\n          <h3>Ricevi clienti</h3>\n          <h5>Niente preventivi e attese, noi ti assicuriamo clienti reali e lavori pronti.</h5>\n        </div>\n      </div>\n      <div class=\"col-xl-4 col-lg-4 col-md-6 col-sm-12\">\n        <div class=\"box\">\n          <img src=\"../../../assets/images/payment-icon.png\" class=\"rounded mx-auto d-block\" alt=\"Ordina il servizio\">\n          <h3>Pagamenti sicuri</h3>\n          <h5>Per i pagamenti ci pensiamo noi! Tutto passa attraverso la nostra piattaforma di pagamento.</h5>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"frase-container\">\n    <div class=\"overlay\">\n      <div class=\"frase\">\n        <h1>Vuoi andare oltre?</h1>\n        <h4>Puoi pubblicare i tuoi servizi personalizzati con i tuoi prezzi. Vai alla pagina del inserimento del servizio e inizia subito.</h4>\n        <button class=\"btn btn-warning\" (click)=\"publishService()\">Pubblica il tuo servizio</button>\n      </div>\n    </div>\n  </div>\n  <div class=\"prefooter-container\">\n    <div class=\"row prefooter\">\n      <div class=\"col-xl-3 col-lg-3 col-md-3 col-sm-12\">\n        <p>Sicurezza del sito</p>\n        <div class=\"list-security\">\n          <img src=\"../../../assets/images/norton.png\" alt=\"Norton Security\">\n          <img src=\"../../../assets/images/secure.png\" alt=\"100% Secure\">\n          <img src=\"../../../assets/images/trust.png\" alt=\"Trusted Website\">\n        </div>\n      </div>\n      <div class=\"col-xl-3 col-lg-3 col-md-3 col-sm-12\">\n        <p>Sistemi di pagamento</p>\n        <div class=\"list-payment-methods\">\n          <img src=\"../../../assets/images/mastercard.png\" alt=\"Mastercard\">\n          <img src=\"../../../assets/images/visa.png\" alt=\"Visa\">\n          <img src=\"../../../assets/images/americanexpress.png\" alt=\"American Express\">\n        </div>\n      </div>\n      <div class=\"col-xl-3 col-lg-3 col-md-3 col-sm-12\">\n        <p><a routerLink=\"/info/legal\">Privacy e Condizioni</a></p>\n        <p><a routerLink=\"/insert/product\">Pubblica un servizio</a></p>\n        <p><a routerLink=\"/info/about\">Chi siamo</a></p>\n      </div>\n      <div class=\"col-xl-3 col-lg-3 col-md-3 col-sm-12\">\n        <p>Seguici su</p>\n        <div class=\"list-socials\">\n          <a href=\"https://www.facebook.com/starbook.co/\" target=\"_blank\"><img src=\"../../../assets/images/facebook.png\" alt=\"Facebook\"></a>\n          <a href=\"https://twitter.com/starbookco/\" target=\"_blank\"><img src=\"../../../assets/images/twitter.png\" alt=\"Twitter\"></a>\n          <a href=\"https://www.instagram.com/starbook.co/\" target=\"_blank\"><img src=\"../../../assets/images/instagram.png\" alt=\"Instagram\"></a>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"footer\">\n    <p><a routerLink=\"/\"><strong>Starbook</strong> © 2017 Tutti i diritti riservati</a></p>\n  </div> -->\n</div>\n\n<div class=\"company-container\" *ngIf=\"page==='1'\">\n  <div class=\"header-container\">\n    <div class=\"header\">\n      <h1>Fai crescere la tua attività senza spendere niente. Per sempre.</h1>\n      <p>Perché non lavorare continuamente per sempre e senza costi di acquisizione clienti? Prova Starbook adesso. Inserisci la tua email e ti aggiorneremo sulla novità a breve.</p>\n      <div class=\"form-group\">\n        <input type=\"text\" class=\"form-control\" placeholder=\"Inserisci il tuo indirizzo email\" id=\"emailInput\">\n        <small>Diamo valore al privacy e non condividiamo mai le tue informazioni</small>\n      </div>\n      <button class=\"btn btn-success myButton\">Aggiornami</button>\n      <!-- <button class=\"btn btn-warning\" (click)=\"registerCompany()\">Iscrivi la tua attività</button> -->\n    </div>\n  </div>\n  <div class=\"message-container\">\n    <div class=\"message\">\n      <div class=\"left picture\">\n        <img src=\"../../assets/images/robot.png\" alt=\"Automatizza\">\n      </div>\n      <div class=\"left content\">\n        <h2>AUTOMATIZZA LA TUA ATTIVITÁ PROFESSIONALE</h2>\n        <p>Cercare di crescere un attività professionale, trovare e fidelizzare i clienti è diventato un problema per molti professionisti, artigiani e giovanni intraprendenti. Un problema molto comune non solo in tempi di crisi ma anche quando la domanda sul mercato è abondante. Abbiamo costruito Starbook per rendere tutto questo più facile e gestito tutto tramite Internet. Piattaforma disponibile in tutta l’italia a tutti i professionisti.</p>\n      </div>\n    </div>\n  </div>\n</div>\n"
