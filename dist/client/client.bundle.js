...
var ProfileComponent = (function () {
    ...
    // PROMOTIONS
    ProfileComponent.prototype.startPromotion = function () {
        console.log(JSON.stringify(this.Promotion));
    };
    ProfileComponent.prototype.selectFacebookAdPeriod = function (option) {
        this.FacebookPromotion.default_time_option = option;
    };
    ProfileComponent.prototype.selectFacebookAdPrice = function (option) {
        this.FacebookPromotion.default_price_options = option;
    };
    ProfileComponent.prototype.selectGoogleAdPeriod = function (option) {
        this.GooglePromotion.default_time_option = option;
    };
    ProfileComponent.prototype.selectGoogleAdPrice = function (option) {
