...
if (environment.production) {
  ...
  app.use('/', require('redirect-https')({ body: '', port: 443, trustProxy: true }))
} else {
  // app.all('/*', function(req: any, res: any, next) {
...
app.get('/sitemap.xml', function(req, res) {
  res.type('text/xml')
  res.send("<?xml version='1.0' encoding='UTF-8'?><urlset xmlns='http://www.sitemaps.org/schemas/sitemap/0.9' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:schemaLocation='http://www.sitemaps.org/schemas/sitemap/0.9 http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd'><url><loc>https://www.starbook.co/</loc></url><url><loc>https://www.starbook.co/company</loc></url><url><loc>https://www.starbook.co/services</loc></url><url><loc>https://www.starbook.co/info/about</loc></url><url><loc>https://www.starbook.co/info/help</loc></url><url><loc>https://www.starbook.co/info/legal</loc></url><url><loc>https://www.starbook.co/auth/worker</loc></url><url><loc>https://www.starbook.co/auth/login</loc></url><url><loc>https://www.starbook.co/insert/product</loc></url><url><loc>https://www.starbook.co/blog</loc></url><url><loc>https://www.starbook.co/business</loc></url></urlset>");
})
