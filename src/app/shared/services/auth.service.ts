...
export class AuthService {
    ...
    constructor(
        // private http: Http, private navigationService: NavigationService
    ) {
        // if (isBrowser) {
    ...
    private _makeHeadersFacebook(access_token: any) {
    ...
    signup(data: any) {
        // return this.http.post(this.api + 'signup', data).toPromise().then((response) => {
        //   if (isBrowser) {
        //     let data = response.json()
        //     var account = data.result
        //     account['token'] = data.token
    ...
    registerWorker(account: any) {
        // return this.http.post(this.api + 'signup', account).toPromise().then((response:any) => {
        //     if (isBrowser) {
        //       let data = response.json()
        //       var account = data.result
        //       account['token'] = data.token
